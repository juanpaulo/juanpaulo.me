...
skel.init({
  ...
  breakpoints: {
    ...
    narrow:   { range: '-980', href: 'stylesheets/style-narrow.css', containers: '95%', grid: { gutters: 30 } },
    narrower: { range: '-840', href: 'stylesheets/style-narrower.css', grid: { collapse: 1 } },
    mobile:   { range: '-640', href: 'stylesheets/style-mobile.css', containers: '100%', grid: { gutters: 15, collapse: 2 } }
  }
}, {
  layers: {
